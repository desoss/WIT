...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_POIS = "create table pois (_id integer primary key autoincrement, wikimapiaId integer not null, name text not null, description text not null,date text not null, woeid integer not null, lat double not null, lon double not null, image blob);";
