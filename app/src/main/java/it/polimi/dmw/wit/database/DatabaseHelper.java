...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_BEST_FIVE = "create table bestFive (_id integer primary key autoincrement, name text not null, description text not null,image blob);";
